...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: CO_ArticuloImportacion (CO_ArticuloImportacion)
   /// </summary>
   public class ArticuloImportacion : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new CODOQry.ArticuloImportacion();
