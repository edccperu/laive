...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: CO_KardexDca (CO_KardexDca)
    /// </summary>
    public class KardexDca : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new CODOQry.KardexDca();
