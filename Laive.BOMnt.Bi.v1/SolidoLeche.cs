...
{
   /// <summary>
   /// Business Object para Mantenimiento a la Tabla: BI_SolidoLeche (BI_SolidoLeche)
   /// </summary>
   public class SolidoLeche : BusinessObjectBase, IBOUpdate
   {
      ...
      private object[] UpdateMaster(ESolidoLeche entity)
      {
      ...
      private void UpdateDetail(IList<ESolidoLeche> col, object[] primKey)
      {
         ...
         foreach (ESolidoLeche objE in col)
         {
      ...
      private void DeleteMaster(ESolidoLeche entity)
      {
