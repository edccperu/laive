...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: SY_ParametroSistema (SY_ParametroSistema)
    /// </summary>
    public class ParametroSistema : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value)  where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new SYDOQry.ParametroSistema();
