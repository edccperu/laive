...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: SY_Periodo (SY_Periodo)
    /// </summary>
    public class Periodo : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new SYDOQry.Periodo();
