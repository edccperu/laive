...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: SY_UnidadEjecSede (SY_UnidadEjecSede)
    /// </summary>
    public class UnidadEjecSede : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new SYDOQry.UnidadEjecSede();
