...
{
   /// <summary>
   /// Data Object para Consultas a la Tabla: SY_Rol (SY_Rol)
   /// </summary>
   /// <remarks></remarks>
   public class Rol : DataObjectBase, IDOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Rol_qry01", arrPrm);
      ...
      public IEntityBase GetByKey(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Rol_qry02", arrPrm);

            objE = null;

            foreach (DataRow dr in dt.Rows)
               objE = DataHelper.CopyDataRowToEntity<ERol>(dr, typeof(ERol));
      ...
      public ICollection<T> GetByParentKey<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Rol_qry03", arrPrm);
      ...
      public ICollection<T> GetList<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Rol_qry04", arrPrm);
      ...
      public ICollection<EntitySelect> GetListForSelect(IEntityBase value)
      {
         ...
         try
         {
            ...
            ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "SY_Rol_qry06", arrPrm);
      ...
      public bool Exists(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("SY_Rol_qry05", arrPrm);
      ...
      public ICollection<T> GetUsuariosXRol<T>(int value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Rol_qry10", arrPrm);
