...
{
    /// <summary>
    /// Data Object para Consultas a la Tabla: SY_Usuario (SY_Usuario)
    /// </summary>
    /// <remarks></remarks>
    public class Usuario : DataObjectBase, IDOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T),"SY_Usuario_qry01", arrPrm);
        ...
        public ICollection<T> GetByParentKey<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Usuario_qry03", arrPrm);
        ...
        public ICollection<T> GetList<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "SY_Usuario_qry04", arrPrm);
        ...
        public ICollection<EntitySelect> GetListForSelect(IEntityBase value)
        {
            ...
            try
            {
                ...
                ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "SY_Usuario_qry06", arrPrm);
        ...
        public IEntityBase GetByKeyXIdLogon(IEntityBase value)
        {
            ...
            try
            {
                ...
                DataTable dt = this.ExecuteDatatable("SY_Usuario_qry10", arrPrm);
