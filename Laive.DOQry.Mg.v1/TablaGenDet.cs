...
{
    /// <summary>
    /// Data Object para Consultas a la Tabla: MG_TablaGenDet (MG_TablaGenDet)
    /// </summary>
    /// <remarks></remarks>
    public class TablaGenDet : DataObjectBase, IDOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "MG_TablaGenDet_qry01", arrPrm);
        ...
        public ICollection<T> GetByParentKey<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "MG_TablaGenDet_qry03", arrPrm);
        ...
        public ICollection<T> GetList<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "MG_TablaGenDet_qry04", arrPrm);
        ...
        public ICollection<EntitySelect> GetListForSelect(IEntityBase value) 
        {
            ...
            try
            {
                ...
                ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "MG_TablaGenDet_qry06", arrPrm);
