...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_ChequeVoucher (FI_ChequeVoucher)
   /// </summary>
   public class ChequeVoucher : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.ChequeVoucher();
