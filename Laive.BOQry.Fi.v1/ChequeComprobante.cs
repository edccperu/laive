...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_ChequeComprobante (FI_ChequeComprobante)
   /// </summary>
   public class ChequeComprobante : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.ChequeComprobante();
