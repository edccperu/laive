...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_BaanBanco (FI_BaanBanco)
   /// </summary>
   public class BaanBanco : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.BaanBanco();
