...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_ChequeLog (FI_ChequeLog)
   /// </summary>
   public class ChequeLog : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.ChequeLog();
