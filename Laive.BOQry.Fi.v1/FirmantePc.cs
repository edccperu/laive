...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_FirmantePc (FI_FirmantePc)
   /// </summary>
   public class FirmantePc : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.FirmantePc();
