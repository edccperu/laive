...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: FI_TipoFirmante (FI_TipoFirmante)
   /// </summary>
   public class TipoFirmante : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new FIDOQry.TipoFirmante();
