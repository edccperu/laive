...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanSubMarca (DI_BaanSubMarca)
   /// </summary>
   public class BaanSubMarca : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanSubMarca();
