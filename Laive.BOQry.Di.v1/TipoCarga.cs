...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: DI_TipoCarga (DI_TipoCarga)
    /// </summary>
    public class TipoCarga : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new DIDOQry.TipoCarga();
