...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanPresentacion (DI_BaanPresentacion)
   /// </summary>
   public class BaanPresentacion : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanPresentacion();
