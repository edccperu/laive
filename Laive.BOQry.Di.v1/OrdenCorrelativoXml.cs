...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_OrdenCorrelativoXml (DI_OrdenCorrelativoXml)
   /// </summary>
   public class OrdenCorrelativoXml : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.OrdenCorrelativoXml();
