...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanPartner (DI_BaanPartner)
   /// </summary>
   public class BaanPartner : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanPartner();
