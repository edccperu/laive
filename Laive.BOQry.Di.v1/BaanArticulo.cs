...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanArticulo (DI_BaanArticulo)
   /// </summary>
   public class BaanArticulo : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanArticulo();
