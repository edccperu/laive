...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: DI_Transportista (DI_Transportista)
    /// </summary>
    public class Transportista : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new DIDOQry.Transportista();
