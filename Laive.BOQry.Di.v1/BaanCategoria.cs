...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanCategoria (DI_BaanCategoria)
   /// </summary>
   public class BaanCategoria : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanCategoria();
