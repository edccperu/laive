...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanMarca (DI_BaanMarca)
   /// </summary>
   public class BaanMarca : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanMarca();
