...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_Plantilla (DI_Plantilla)
   /// </summary>
   public class Plantilla : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.Plantilla();
