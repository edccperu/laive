...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_AlmacenSerie (DI_AlmacenSerie)
   /// </summary>
   public class AlmacenSerie : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.AlmacenSerie();
