...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_BaanCanal (DI_BaanCanal)
   /// </summary>
   public class BaanCanal : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.BaanCanal();
