...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_PrioridadAtencion (DI_PrioridadAtencion)
   /// </summary>
   public class PrioridadAtencion : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.PrioridadAtencion();
