...
{
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_TipoResultadoAsignacion (DI_TipoResultadoAsignacion)
   /// </summary>
   public class TipoResultadoAsignacion : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.TipoResultadoAsignacion();
