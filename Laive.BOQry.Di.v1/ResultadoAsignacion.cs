...
namespace Laive.BOQry.Di
{
   ...
   /// <summary>
   /// Business Object para Consultas a la Tabla: DI_ResultadoAsignacion (DI_ResultadoAsignacion)
   /// </summary>
   public class ResultadoAsignacion : BusinessObjectBase, IBOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         IDOQuery objData = (IDOQuery)new DIDOQry.ResultadoAsignacion();
