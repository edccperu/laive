...
{
    /// <summary>
    /// Business Object para Consultas a la Tabla: MG_CentroCosto (MG_CentroCosto)
    /// </summary>
    public class CentroCosto : BusinessObjectBase, IBOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            IDOQuery objData = (IDOQuery)new MGDOQry.CentroCosto();
