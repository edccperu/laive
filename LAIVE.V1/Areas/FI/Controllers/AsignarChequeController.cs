...
{
   public class AsignarChequeController : SamcontrollerBase
    {
       [HttpGet]
       ...
       public JsonResult GetDataGrdCheques(string filtro)
       {
          ...
          string[] estadosList = { ConstEstadoCheque.CARGADO, ConstEstadoCheque.ASIGANDO, ConstEstadoCheque.REVERTIR};
       ...
       { 
            ...
            //string stFecha = dtFechaLog.ToString("dd/MM/yyyy HH:mm tt");
            ...
            try
            {
               ...
               foreach (string idCheque in chequeIds)
               {
                  ...
                  eCheque.FechaLog = dtFechaLog;
                  if (esFirmaManual)
                     
                        eCheque.CodigoEstado = ConstEstadoCheque.FIRMA_MANUAL;
                  //eCheque.Tipo = ConstTipoCheque.MANUAL;
                  else
