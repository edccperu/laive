...
{
    public class FirmaManualController : Controller
    {
       [HttpGet]
       ...
       public JsonResult GetDataGrdCheques(string filtro)
       {
          ...
          //string[] estadosList = { ConstEstadoCheque.FIRMA_MANUAL };
          //string[] estadosList = { ConstEstadoCheque.ASIGANDO };
          string[] estadosList = { ConstEstadoCheque.VERIFICAR };
          string[] tipoList = { ConstTipoCheque.MANUAL };
          filtros.Add(new FilterOperator("a.codigoEstado", EnumConectorFilter.IN, estadosList));
          filtros.Add(new FilterOperator("a.Tipo", EnumConectorFilter.IN, tipoList));
       ...
       [HttpPost]
       public JsonResult RegresarChequeFirmado(string pIdCheques)
       {
          ...
          {
             FIBOQry.ICheque objBO = (FIBOQry.ICheque)WCFHelper.GetObject<FIBOQry.ICheque>(typeof(FIBOQry.Cheque));
             //objBO.RegresarChequeFirmado(pIdCheques);
             message.Status = JsonMessageStatus.SUCCESS;
             message.Message = "El cheque fue rechazado  con éxito.";
