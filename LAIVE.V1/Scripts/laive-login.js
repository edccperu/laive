...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
	   ...
	   neonLogin.$container = $("#form_login");
		...
		neonLogin.$container.data("validator").settings.submitHandler = function (form) {
		   ...
		   setTimeout(function () {
		      ...
		      neonLogin.setPercentage(30 + random_pct);

		      var postData = {
		         IdLogon: $("input#UserName").val(),
		      ...
		      $.ajax({
		         ...
		         error: function (xhr, ajaxOptions, thrownError) {
		            ...
		            $(".login-content-error").html("Verifique su acceso a Internet.");
		         ...
		         success: function (response) {
		            ...
		            setTimeout(function () {
		               ...
		               if (login_status == 'invalid') {
		                  $(".login-page").removeClass('logging-in');
		                  $(".login-content-error").html(response.Message);
