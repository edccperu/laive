...
(function ($) {
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({ //apply default properties
            ...
            novstripe: false,
            minwidth: 18, //min width of columns
            ...
            title: false,
            idProperty: 'id',
            pagestat: 'Total de Registros : {total}',
            pagetext: 'Page',
            outof: 'of',
            findtext: 'Find',
            ...
            query: '',
            qtype: '',
            nomsg: 'No se encontraron Registros',
        ...
        var g = {
            ...
            addRowProp: function () {
                $('tbody tr', g.bDiv).on('click', function (e) {
                    ...
                    if (p.onClickRow) p.onClickRow(this);
        ...
        if (p.usepager) {
            ...
            $(g.bDiv).after(g.pDiv);
            var html = '<div class="pGroup"><span class="pPageStat"></span></div><div class="pGroup"> <div class="pReload pButton"><span></span></div> </div>';
    ...
    $.fn.selectedRows = function (p) {
        ...
        $(selector).each(function (i, row) {
            ...
            $.each(row.cells, function (c, cell) {
                var col = cell.abbr;
                var val = (cell.children[0].innerText || cell.children[0].innerHTML).trim();
