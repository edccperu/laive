      ...
      ImmyBox = (function () {
         function ImmyBox(element, options) {
            ...
            this.queryResultArea.on('click', "li." + pluginName + "_choice", function () {
               ...
               self.element.focus();
               if (self.options.fnOnClick != null)
                  self.options.fnOnClick(self.getChoice());
            });
         ...
         ImmyBox.prototype.selectHighlightedChoice = function () {
            ...
            if (highlightedChoice != null) {
               ...
               this._val = this.element.val();
               this.hideResults();
               if (this.options.fnOnClick != null)
                  this.options.fnOnClick(this.getChoice());
            } else {
               this.revert();
            }
         };
         ...
         ImmyBox.prototype.publicMethods = ['showResults', 'hideResults', 'getChoices', 'getChoice', 'setChoices', 'getValue', 'setValue', 'destroy'];
         ...
         ImmyBox.prototype.getChoice = function () {
            if (this.selectedChoice != null) {
