...
namespace Laive.Entity.Di
{
    ...
    /// </summary>
    public class EResultadoAsignacion : IEntityBase
    {
        ...
        public string DsUserProceso { get; set; }

        public List<Column> ColumnSet()
        {
            List<Column> columnSet = new List<Column>();
            columnSet.Add(new Column("FechaProceso", "", true, "dd/MM/yyyy HH:mm:ss"));
            columnSet.Add(new Column("CodigoResultado"));
            columnSet.Add(new Column("GlosaResultado"));
            ...
            columnSet.Add(new Column("IdUserProceso"));
            columnSet.Add(new Column("DsUserProceso"));
            return columnSet;
        }
    }
}
