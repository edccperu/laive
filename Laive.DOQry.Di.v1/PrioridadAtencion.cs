...
{
   /// <summary>
   /// Data Object para Consultas a la Tabla: DI_PrioridadAtencion (DI_PrioridadAtencion)
   /// </summary>
   /// <remarks></remarks>
   public class PrioridadAtencion : DataObjectBase, IDOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_PrioridadAtencion_qry01", arrPrm);
      ...
      public IEntityBase GetByKey(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("DI_PrioridadAtencion_qry02", arrPrm);

            objE = null;

            foreach (DataRow dr in dt.Rows)
               objE = DataHelper.CopyDataRowToEntity<EPrioridadAtencion>(dr, typeof(EPrioridadAtencion));
      ...
      public ICollection<T> GetByParentKey<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_PrioridadAtencion_qry03", arrPrm);
      ...
      public ICollection<T> GetList<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_PrioridadAtencion_qry04", arrPrm);
      ...
      public ICollection<EntitySelect> GetListForSelect(IEntityBase value)
      {
         ...
         try
         {
            ...
            ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "DI_PrioridadAtencion_qry06", arrPrm);
      ...
      public bool Exists(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("DI_PrioridadAtencion_qry05", arrPrm);
