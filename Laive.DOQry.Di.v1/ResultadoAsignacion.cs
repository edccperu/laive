...
{
   /// <summary>
   /// Data Object para Consultas a la Tabla: DI_ResultadoAsignacion (DI_ResultadoAsignacion)
   /// </summary>
   /// <remarks></remarks>
   public class ResultadoAsignacion : DataObjectBase, IDOQuery
   {
      ...
      public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
      {
         ...
         EResultadoAsignacion objE = (EResultadoAsignacion)value;
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_ResultadoAsignacion_qry01", arrPrm);
      ...
      public IEntityBase GetByKey(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("DI_ResultadoAsignacion_qry02", arrPrm);

            objE = null;

            foreach (DataRow dr in dt.Rows)
               objE = DataHelper.CopyDataRowToEntity<EResultadoAsignacion>(dr, typeof(EResultadoAsignacion));
      ...
      public ICollection<T> GetByParentKey<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_ResultadoAsignacion_qry03", arrPrm);
      ...
      public ICollection<T> GetList<T>(IEntityBase value) where T : new()
      {
         ...
         try
         {
            ...
            ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_ResultadoAsignacion_qry04", arrPrm);
      ...
      public ICollection<EntitySelect> GetListForSelect(IEntityBase value)
      {
         ...
         try
         {
            ...
            ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "DI_ResultadoAsignacion_qry06", arrPrm);
      ...
      public bool Exists(IEntityBase value)
      {
         ...
         try
         {
            ...
            DataTable dt = this.ExecuteDatatable("DI_ResultadoAsignacion_qry05", arrPrm);
      ...
      private ArrayList BuildParamInterface(EResultadoAsignacion value)
      {
