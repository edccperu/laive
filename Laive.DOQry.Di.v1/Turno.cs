...
namespace Laive.DOQry.Di
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class Turno : DataObjectBase, IDOQuery
    {
        ...
        public ICollection<T> GetByCriteria<T>(IEntityBase value) where T : new()
        {
            ...
            try
            {
                ...
                ICollection<T> dt = this.ExecuteGetList<T>(typeof(T), "DI_Turno_qry01", arrPrm);
        ...
        public ICollection<EntitySelect> GetListForSelect(IEntityBase value)
        {
            ...
            try
            {
                ...
                ICollection<EntitySelect> dt = this.ExecuteGetList<EntitySelect>(typeof(EntitySelect), "DI_Turno_qry06", arrPrm);
